...
<body bgcolor="#ecf0f1" style="background-image:url('imgs/homepage3.JPG');">
	...
	<div id="main">
	<button class="openbtn" onclick="openNav()">☰ </button> <font color="#1e3799"><center><span class="openbtn2">Integrated Workplace Management System</span></center></font>
	<h1 align="center"></h1>
	<br><br><br><br><br><br>
	<center>
<a href="viewuserdata.php"><input type="button" class="hello" value="Click Here to view User's Data"/></a><br><br>
<a href="viewbookingdata.php"><input type="button" class="hello" value="Click Here to view Booking Data"/></a>
</center>
</div>
